...
public class DemoNoSQLTableConversation extends DemoNoSQLTableBase {
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        firstItem.setImageUrlPath(DemoSampleDataGenerator.getSampleStringSet());
        firstItem.setMessage(DemoSampleDataGenerator.getSampleStringSet());
        ...
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            ...
            item.setImageUrlPath(DemoSampleDataGenerator.getSampleStringSet());
            item.setMessage(DemoSampleDataGenerator.getSampleStringSet());
